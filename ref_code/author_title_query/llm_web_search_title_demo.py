#!/usr/bin/env python3
"""
OpenRouter web-search demo for scholar honor/title lookup.

Example:
  python ref_code/author_title_query/llm_web_search_title_demo.py \
...
def _call_openrouter_chat(prompt: str, settings: Mapping[str, Any]) -> Tuple[str, List[Dict[str, Any]]]:
    ...
    if web_search_mode == "online" and not model.endswith(":online"):
...
def main() -> None:
    ...
    _print_block("Stage 1: Honor Check", content1, _render_citations(annotations1))
